...
class CreditNoteInput
{
    ...
    public static function format($data)
    {
        return (object)[
            ...
            'time_of_issue' => $data['hora_de_emision'],
            ...
            'total_discount' => $data['totales']['total_descuentos'] ?? 0,
            ...
            'note' => (object)[
                'note_credit_type_id' => $data['codigo_tipo_nota'],
                'note_description' => $data['motivo_o_sustento_de_nota'],
                'affected_document' => (object)[
                    'number' => $data['documento_afectado']['numero_documento'],
                    'series' => $data['documento_afectado']['serie_documento'],
                    'document_type_id' => $data['documento_afectado']['codigo_tipo_documento'],
                ]
            ]
        ];
    }
